...
%         [C2,V2] = smoother(Cm,V,dCmin);
     ...
     %Plot CV%       
        ...
        Legend_eachC=[(sample_info{x,5}),'-InAlAs',' (',sample_info{x,9},' ',num2str((sample_info{x,2})),' ',filename1(1:end-4),')']        
...
%        Legend_eachG= [(sample_info{x,5}),'-InAlAs (' ,num2str((sample_info{x,2})),' ', num2str(sample_info{x,6}),'-',filename1(1:end-4),')']
        Legend_eachG = [(sample_info{x,5}),'-InAlAs',' (',sample_info{x,9},' ',num2str((sample_info{x,2})),' ',filename1(1:end-4),')']   
...
%        ylim('auto')
        ylim([10.^-4 10.^2])
        set(Ax2, 'YTick', [10.^-4 10.^-3 10.^-2 10.^-1 10.^0 10.^1 10.^2])
%        xlim('auto')
        set(Ax2,'XLim',[-1.5 7])
...
%         ylim('auto')
         ylim([10.^14 10.^19])
         set(Ax4, 'YTick', [10.^14 10.^15 10.^16 10.^17 10.^18 10.^19])
...
%         ylim('auto') 
          ylim([10.^14 10.^19])
         set(Ax5, 'YTick', [10.^14 10.^15 10.^16 10.^17 10.^18 10.^19])
         set(Ax5,'XLim',[40 300])
