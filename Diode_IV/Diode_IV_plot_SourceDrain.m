...
%         ylim('auto')
        ylim([10.^-3 10.^4])
        set(Ax2, 'YTick', [10.^-3 10.^-2 10.^-1 10.^0 10.^1 10.^2 10.^3 10.^4])
%          ylim([10.^-7 10.^-2])
%          set(Ax2, 'YTick', [10.^-7 10.^-6 10.^-5 10.^-4 10.^-3 10.^-2])

        set(Ax2,'XLim',[-0.5 7])
        set(Ax2, 'XTick', [0 1 2 3 4 5 6 7])
