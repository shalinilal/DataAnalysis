classdef MapN < handle
    ...
    % data that you want stored in the Map object, and a key list is a
    ...
    % exception is thrown. (This is different containers.Map, which issues
    % a warning. The advantage of an exception is that it can be caught.)
    %
