...
%          a1(i,1) = (S1{j,2}); %Drain Voltage%
%        a1(i,2) = (S1{i+5,3}); %Drain Current%
%        a1(i,3) = (S1{i+5,4}); %Gate Voltage%
%        a1(j,4) = (a1{i+5,5}); %Gate Current%
    j=j+1;
...
%  hold on
%  p1=plot(a1(:,1),(a1(:,2)*(10^-3)),'LineWidth',2,'Color','k');
%  L1=['ID (',S4,'mA)'];
%  
%  lg1=legend(p1,L1);
