...
clear i_DevData i_MetricData i_LapSeries i_Vc i_row count i_Xcol i_LapSeriesCol i_no_of_Y_LapSeries
...
for i_Y1_label = 1:1:size(Metric_Data,2)
    Y1_label{1,i_Y1_label} = strcat(Metric_Data{2,i_Y1_label}(1),'_{',Metric_Data{2,i_Y1_label}(2:end),'}')
    Y1_units{1,i_Y1_label} = Metric_Data{3,i_Y1_label}
end    
