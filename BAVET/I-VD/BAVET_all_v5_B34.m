...
% %+++++++++++++++++ Fit I-VD for Vg=0 to -1V +++++++++++++++++++++++++++     
  %get Ron, turn-on voltage, output conductance
    for i_column2=1:1:2  % for Vg of 0V and -1 V  
        ...
        i_X_start1{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 0.4))); % 0.4index when Vd > 1.5V
        i_X_end1{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 1.6))); % 1.6index when Vd > 2V
        ...
        i_X_start2{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 4))); % 4.5 or 8index when Vd > 1.5V
        i_X_end2{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 6))); % 7 or 10index when Vd > 2V
        ...
        i_X_start3{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 9))); % 10.5index when Vd > 1.5V
        i_X_end3{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 11))); % 11.9index when Vd > 2V
...
%+++++++++++++++++ Fit I-VD for Vg=-2V +++++++++++++++++++++++++++
      % Vdsat, Ron and Gout Fit for Vgs = -2 V
        % Fit for low Vds to get Vturn-on
        i_X_start1{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 0.4))); % 0.4index when Vd > 1.5V
        i_X_end1{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 1.6))); % 2.2index when Vd > 2V
        ...
        i_X_start2{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 3))); % 4 or 7.5 index when Vd > 1.5V
        i_X_end2{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 6))); % 6.8 or 10index when Vd > 2V
        ...
        i_X_start3{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 9))); % 9index when Vd > 1.5V
        i_X_end3{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 10))); % 11.9index when Vd > 2V
...
%+++++++++++++++++ Fit I-VD for Vg=-5,-6V +++++++++++++++++++++++++++    
    % Fit for I-Vd when Vg=-6, -5 V 
     for i_column5=6:1:7  % for Vg of -5V and -6 V  
        ...
        % Fit for saturated I-V to get Vdsat and output-conductance
        i_X_start7{i_column5} = min(find((X(1:iXmax_percontrol_var(i_column5),i_column5) > 4))); % 5index when Vd > 1.5V
        i_X_end7{i_column5} = min(find((X(1:iXmax_percontrol_var(i_column5),i_column5) > 6))); % 8index when Vd > 2V
...
%+++++++++++++++++ Fit I-Vg for Vd of 9,10,11V +++++++++++++++++++++++++++                  
                    ...
                    i_X_start4{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -4.5))); % -5index when Vd > 1.5V
                    i_X_end4{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -5.7))); % -5.9index when Vd > 2V
                    ...
                    % Ends - Fit for mid Vds to get Vturn-on2
                    i_X_start5{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -1.5))); % -1.6index when Vd > 1.5V
                    i_X_end5{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -2.2))); % -2.8index when Vd > 2V
...
%+++++++++++++++++ Fit low I-Vg for Vd of 5,6,7V +++++++++++++++++++++++++++                     
                    ...
                    z7=1
                     % Fit for low Vgs to get Vth1
                    i_X_start6{i_column4} = min(find((X(1:iXmin_percontrol_var(i_column4),i_column4) < -4.5))); % -5index when Vd > 1.5V
                    i_X_end6{i_column4} = min(find((X(1:iXmin_percontrol_var(i_column4),i_column4) < -5.2))); % -5.9index when Vd > 2V
