...
% %+++++++++++++++++ Fit I-VD for Vg=0 to -1V +++++++++++++++++++++++++++  
  %get Ron, turn-on voltage, output conductance
    for i_column2=1:1:2  % for Vg of 0V and -1 V  
        ...
        i_X_start1{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 0.1)));  % 0.25index when Vd > 1.5V
        i_X_end1{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 0.8))); % 0.85index when Vd > 2V
        ...
        i_X_start2{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 1.8))); % 2index when Vd > 1.5V
        i_X_end2{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 3.0))); % 3.4index when Vd > 2V
        ...
        i_X_start3{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 5))); % 6index when Vd > 1.5V
        i_X_end3{i_column2} = min(find((X(1:iXmax_percontrol_var(i_column2),i_column2) > 6.9))); % 6.99index when Vd > 2V
...
%+++++++++++++++++ Fit I-VD for Vg=-2V +++++++++++++++++++++++++++
      % Vdsat, Ron and Gout Fit for Vgs = -2 V
        ...
        i_X_end1{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 0.8))); % 2.2index when Vd > 2V
        ...
        i_X_start2{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 0.7))); % 6 or 7.5 index when Vd > 1.5V
        i_X_end2{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 2.2))); % 9.5 or 10index when Vd > 2V
        ...
        i_X_start3{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 4))); % 10.5index when Vd > 1.5V
        i_X_end3{3} = min(find((X(1:iXmax_percontrol_var(3),3) > 5.7))); % 11.9index when Vd > 2V
...
%+++++++++++++++++ Fit I-Vg for Vd of 4,5,6V +++++++++++++++++++++++++++
                    ...
                    i_X_start4{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -3.5))); % % -3.3index when Vd > 1.5V
                    i_X_end4{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -4.25))); % -4.5index when Vd > 2V
                    ...
                    % Ends - Fit for mid Vds to get Vturn-on2
                    i_X_start5{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -0.3))); % -0.8index when Vd > 1.5V
                    i_X_end5{i_column3} = min(find((X(1:iXmin_percontrol_var(i_column3),i_column3) < -1.3))); % -1.8index when Vd > 2V
...
%+++++++++++++++++ Fit low I-Vg for Vd of 4V +++++++++++++++++++++++++++                    
                    ...
                    z7=1
                     % Fit for low Vgs to get Vth1
                    i_X_start6{i_column4} = min(find((X(1:iXmin_percontrol_var(i_column4),i_column4) < -3.0)));  % -3.3index when Vd > 1.5V
                    i_X_end6{i_column4} = min(find((X(1:iXmin_percontrol_var(i_column4),i_column4) < -3.5))); % -4.5index when Vd > 2V
