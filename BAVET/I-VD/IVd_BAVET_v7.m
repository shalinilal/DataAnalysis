...
clear i_dir;
i_dir=1;
clear Lap Wap Lgo Lga Ap_Area Gt_Area PlotData FileData sample_info index_sampleinfo i_slashes
...
clear VdminperVg iVdminperVg Legend_name PlotLegend1 V_turnon R_on
