...
%         %TitleStr1=[sample_info{1,2},' (',sample_info{1,4},'-InAlAs/InGaAs/) ',sample_info{1,5},' ', sample_info{1,6}]
         TitleStr1=[sample_info{1,2},' (',sample_info{1,4},'-InAlAs/InGaAs/',sample_info{1,6},') ',sample_info{1,5}, ' BAVETs with L_{GO}= ', num2str(Lgo_title),' ',char(0181),'m', ' and L_{GA}= ', num2str(Lga_title),' ',char(0181),'m',' ',Y1_label{1,i_Y1inLapSeries+2},' vs. ',X_label, ' for ', Y1_label{1,2},' = ',  num2str(Vc_label(1,1)),' V, ', num2str(LapSeries(2,2)),' V and ',num2str(LapSeries(3,2)),' V']
%           
