...
clear no_of_Vc i_Vc_col i_Vc_row i_Vc_col i_col_metric2 i_LapSeries1 i_LapSeries2 i_LapSeries3 i_Lap_noofVc i_col_Y1_perVc i_Y1_col Vc_row Lap_old_forVc Lap_new_forVc 
z10=0
clear NaN_values_TF no_of_Vc Vc_row  Vc_value Vc_label Lap_old_forVc Lap_new_forVc i_Vc_col i_Vc_row
...
%no_of_Vc{1,i_col_metric-2}=0
    for i_Vc_row =1:1:Vc_row
        for i_LapSeries3 =1:1:length(NaN_values_TF)  
           ...
           % else    no_of_Vc(i_Vc_row,i_Vc_col)=1
            end
        end
    end    
 end   
...
for i_Vc_col2 =2:1:size(no_of_Vc,2)
%     x1=0
    for i_Vc_row2 =1:1:length(no_of_Vc)
        if no_of_Vc(i_Vc_row2,i_Vc_col2) > 0
           z=find((NaN_values_TF(:,i_Vc_col2+1) ==0))
           for i_no_of_Vc_perY1=1:1:no_of_Vc(i_Vc_row2,i_Vc_col2)
             %X2(:,i_Vc_col2-1+i_no_of_Vc_perY1-1)=LapSeries(z,1)
%              row_index_Y1=i_Vc_row2
%              row_index_lapseries=z(x1+i_no_of_Vc_perY1,1)
%              col_index_Y1=col_index_Y1 + i_no_of_Vc_perY1
%              col_index_lapseries=i_Vc_col2+1
            %  Y1(row_index_Y1,col_index_Y1)=  LapSeries(row_index_lapseries,col_index_lapseries);
            
           end %for i_LapSeries3=1:1:length(LapSeries)    
        end %if no_of_Vc(i_Vc_row2,i_Vc_col2)>0
%         x1=x1+1
    end %for i_Vc_row2 =1:1:length(no_of_Vc)
    
 end  %for i_Vc_col2 =2:1:size(no_of_Vc,2)
